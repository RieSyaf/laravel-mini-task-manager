<table class="w-full text-left border-collapse">
    <thead>
        <tr>
            ...
            <th class="border-b border-gray-600 py-2 w-32 whitespace-nowrap text-center">
                {{ $isDashboard ? 'Last Updated' : 'Created At' }}
            </th>
    ...
    <tbody>
        @forelse($projects as $project)
            ...
            <tr class="hover:bg-gray-700 transition duration-150">
                <td class="border-b border-gray-600 py-3 font-medium">{{ $project->name }}</td>
                
                <td class="border-b border-gray-600 py-3 px-4">
                    @if($total > 0)
                ...
                <td class="border-b border-gray-600 py-3 text-center w-32 whitespace-nowrap text-gray-300">
                    {{ $isDashboard ? $project->updated_at->format('M d, Y') : $project->created_at->format('M d, Y') }}
                </td>
                
                <td class="border-b border-gray-600 py-3 text-center w-32 whitespace-nowrap">
